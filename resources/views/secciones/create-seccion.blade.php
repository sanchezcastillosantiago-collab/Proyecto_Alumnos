...
@section('content')
    <div class="container py-4">
        <div class="card">
            <div class="card-body">
                <h1 class="h4 mb-3">Crear Sección</h1>
                ...
                <form action="{{ route('secciones.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="seccion" name="seccion" value="{{ old('seccion') }}" class="form-control @error('seccion') is-invalid @enderror" required />
                        @error('seccion') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="mb-3">
                        <label for="aula" class="form-label">Aula</label>
                        <input type="text" id="aula" name="aula" value="{{ old('aula') }}" class="form-control @error('aula') is-invalid @enderror" />
