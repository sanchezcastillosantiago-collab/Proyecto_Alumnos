<x-layouts.app :title="__('Dashboard')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <div class="relative h-full flex-1 overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700 p-4 bg-white dark:bg-zinc-900">
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                if (periodSelect) {
                    periodSelect.addEventListener('change', function () {
                        // simulación: cambiar los datos del gráfico según el periodo seleccionado
